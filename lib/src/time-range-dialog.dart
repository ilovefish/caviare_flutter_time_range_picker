...
import 'package:caviare_flutter_time_range_picker/src/clock-gesture-recognizer.dart';
import 'package:caviare_flutter_time_range_picker/src/clock-painter.dart';
import 'package:caviare_flutter_time_range_picker/src/utils.dart';
...
class _TimeRangePickerState extends State<TimeRangePicker>
  ...
  Widget buildButtonBar({required MaterialLocalizations localizations}) =>
      ButtonBar(
        children: <Widget>[
          TextButton(
            child: Text(localizations.cancelButtonLabel,style: TextStyle(fontFamily: 'fzYouMaoZaiJ', color: Color(0xFF594F5E))),
            onPressed: _cancel,
          ),
          TextButton(
            child: Text(localizations.okButtonLabel,style: TextStyle(fontFamily: 'fzYouMaoZaiJ', color: Color(0xFF594F5E))),
            onPressed: _submit,
          ),
        ],
      );
